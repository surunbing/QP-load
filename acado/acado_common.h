 ...
 * 
 *  Matrix containing 10 reference/measurement vectors of size 7 for first 10 nodes.
 */
real_t y[ 70 ];
...
/** Row vector of size: 716 */
real_t rk_xxx[ 716 ];

/** Matrix of size: 4 x 696 (row major format) */
real_t rk_kkk[ 2784 ];
...
/** Matrix of size: 240 x 24 (row major format) */
real_t evGx[ 5760 ];
...
/** Matrix of size: 1320 x 4 (row major format) */
real_t E[ 5280 ];
...
/** Matrix of size: 10 x 64 (row major format) */
real_t A[ 640 ];
